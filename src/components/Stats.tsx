  ...
  return (
    <section className="relative px-4 py-16 bg-gray-900 overflow-hidden min-h-screen">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-64 h-64 bg-cyan-600 rounded-full mix-blend-multiply filter blur-3xl opacity-5 animate-pulse" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="container mx-auto relative z-10 py-6">
        ...
        <div className="text-center mb-12 max-w-3xl mx-auto">
          <div className="inline-block mb-3 px-3 py-1 bg-teal-500/10 border border-teal-500/20 rounded-full">
            <span className="text-teal-400 text-sm font-medium">业界标杆 · 卓越体验</span>
          </div>
          ...
          <div className="flex items-center justify-center gap-3 mb-6">
            <div className="px-4 py-2 rounded-full bg-blue-500/10 text-blue-400 text-sm border border-blue-500/20">高速稳定</div>
            <div className="px-4 py-2 rounded-full bg-teal-500/10 text-teal-400 text-sm border border-teal-500/20">快速响应</div>
            <div className="px-4 py-2 rounded-full bg-purple-500/10 text-purple-400 text-sm border border-purple-500/20">全球覆盖</div>
          </div>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center transform transition-transform hover:scale-105 duration-300">
                  ...
                  <div className="relative">
                    ...
                    <h3 className="text-4xl font-bold mb-2 text-white relative">122,888</h3>
                  </div>
                ...
                <div className="text-center transform transition-transform hover:scale-105 duration-300">
                  ...
                  <div className="relative">
                    ...
                    <h3 className="text-4xl font-bold mb-2 text-white relative">168,888</h3>
                  </div>
                ...
                <div className="text-center transform transition-transform hover:scale-105 duration-300">
                  ...
                  <div className="relative">
                    ...
                    <h3 className="text-4xl font-bold mb-2 text-white relative">899,188</h3>
                  </div>
            ...
            <div className="bg-gradient-to-b from-gray-900 to-gray-950 p-6 rounded-2xl h-full">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="w-full h-2 bg-gray-800 rounded-full">
                    <div className="h-full bg-gradient-to-r from-blue-500 to-purple-500 rounded-full" style={{width: '97%'}}></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-b from-gray-900 to-gray-950 p-6 rounded-2xl h-full">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <h4 className="text-white font-medium mb-1">全球覆盖</h4>
                    <p className="text-gray-400 text-sm">120+国家地区IP资源</p>
                  </div>
                </div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-gray-400 mb-4">加入我们的优质用户群体，体验无忧IP带来的高速稳定服务</p>
